...
\begin{figure}[h]
\begin{center}
\includegraphics[scale=0.5]{dp_absFact.png}
...
Use o padrão \textbf{Observador} nas seguintes situações:
\begin{itemize}

...
Um outro diferencial da programação orientada a objetos é o tratamento de erros. Na programação OO, a estrutura \emph{try-catch} permite isolar o código para o processamento sem erros do código para o processamento das situações de erro.
...
Na figura \ref{fig:uml3}, a classe \emph{Veiculo} está marcada como abstrata (o nome está em itálico, em versões mais antigas de UML, você poderia usar a restrição \emph{{abstract}\emph{•}}), enquanto \emph{Aviao} e \emph{Carro} não são. Dizemos que 

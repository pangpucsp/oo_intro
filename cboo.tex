...
Antes de começarmos com a orientação a objetos, relembremos os principais paradigmas de programação disponíveis para o desenvolvimento de software.
\begin{itemize}

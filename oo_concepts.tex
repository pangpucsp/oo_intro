...
\textbf{É uma questão de ritmo}

O ciclo da arrancada é o ritmo fundamental do processo scrum. Como quer você chame seu período de desenvolvimento: uma arrancada (\emph{sprint}), um ciclo, ou uma iteração. Você está sempre falando da mesma coisa: Um período fixo de tempo no qual você mastiga pedaços do seu projeto e termina-os antes de morder mais. No final da arrancada, você mostrará algum software funcionando.
...
A tabela abaixo mapeia as cerimônias que você deve agendar para uma arrancada de uma semana. A duração das cerimônias são uma sugestão para iniciar, as equipes devem adaptar para suas próprias características.
% inserir tabela, talvez do google docs

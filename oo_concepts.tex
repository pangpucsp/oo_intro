...
Neste capítulo veremos um resumo das idéias apresentadas em \citeonline{DP:explained}. Os autores deste livro acreditam que os alunos podem aprender o desenvolvimento OO simultaneamente com os padrões de projeto. Não veremos os padrões com a minúcia de \citeonline{DP:explained}, mas apenas alguns dos aspectos mais essenciais. Os leitores mais interessados em padrões de projeto devem ler o texto original.

\subsection{O Padrão Fachada}
\subsection{O Padrão Adaptador}
\subsection{O Padrão Estratégia}
\subsection{O Padrão Ponte}
\subsection{O Padrão Fabrica Abstrata}
\subsection{O Padrão Decorador}
\subsection{O Padrão Observador}
\subsection{O Padrão Método Gabarito}
\subsection{O Padrão Construtor}
\subsection{O Padrão Método Fabrica}
\subsection{O Padrão Protótipo}
\subsection{O Padrão Singleton}
\subsection{O Padrão Trava Duplamente Verificada}
\subsection{O Padrão Piscina de Objetos}
\subsection{O Padrão }
\subsection{O Padrão }
\subsection{O Padrão }
\subsection{O Padrão }
...
\subsection{A Lista de Pendências do Produto}

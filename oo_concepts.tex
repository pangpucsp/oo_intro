...
\hline %\hline
 & \legend{Fonte: Fortemente baseada em \cite{Ambler:TOP:3ed}}
\endlastfoot
...
\hline %\hline
& \legend{Fonte: \cite{Ambler:TOP:3ed}}
\endlastfoot
...
Começaremos apresentando um catálogo de padrões de projetos dos dois livros, \citeonline{design:patterns} e \citeonline{DP:explained}. Depois veremos algumas aplicações destes padrões. Em geral, não aplicamos os padrões de maneira isolada, mas para resolver alguns problemas aplicamos diversos padrões. Apesar da \textit{gang de 4}\footnote{\citeonline{design:patterns}} apresentar os padrões em ordem alfabética, procuraremos estudar os padrões pelos mais simples e familiares. Além disso, procuramos deixar próximos os padrões que estão correlacionados.
...
É comum, projetistas inexperientes não saberem diferenciar os dois padrões: Fachada e Adaptador. \citeonline{DP:explained} fornecem a seguinte tabela para compará-los:

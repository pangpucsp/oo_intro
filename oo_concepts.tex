...
\begin{enumerate}
\item \textbf{Deve ter algum tipo de relacionamento.}

\item \textbf{Deve ter um método correspondente no objeto algo.}

\item \textbf{Pode haver um valor de retorno.}

\item \textbf{Pode ter ou não parâmetros.}

\item \textbf{Mensagens mostram a colaboração, não o fluxo de dados.}

\item \textbf{Algumas vezes o alvo precisa colaborar.}

\item \textbf{Cada método deve fazer alguma coisa.}

\item \textbf{Um objeto pode colaborar consigo mesmo.}
